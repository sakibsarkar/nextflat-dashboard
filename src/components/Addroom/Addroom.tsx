...
const Addroom = ({title, isUrgent}: {title: string; isUrgent?: boolean}) => {
    return (
                ...
                <div className="flex-1 flex flex-col  justify-start xl:flex-nowrap xl:flex-col items-start xl:justify-start gap-[10px]">
                    ...
                    <div className="flex mt-[20px] items-stretch flex-wrap gap-[20px]">
                        <div className="lg:self-start">
                            {isUrgent ? <EnableBox text="Already Rent" /> : <EnableBox text="Already rent" />}
                        </div>
                        ...
                        <div className="lg:self-end">{isUrgent ? <EnableBox text="Urgent" /> : null}</div>
                    </div>
                </div>
